...
function reverseString(element){
	...
	var charCheck = new RegExp("[*\.\!\,\?\:\;]");

	var revEl = element.split("").reverse().join("");

	var match = charCheck.exec(revEl);
	if (match !== null && match.index === 0){
		revEl = revEl.substr(1) + revEl.substr(0, 1);
	}
	return revEl;
}

console.log(oddWord(string1));